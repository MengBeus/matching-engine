...
// SuccessResponse represents the unified success envelope.
type SuccessResponse struct {
	Code      string `json:"code"`       // Business status code, fixed to "OK" for success
	Data      any    `json:"data"`       // Payload object
	RequestID string `json:"request_id"` // Request trace ID
}
